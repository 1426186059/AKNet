...
namespace KNet.LinuxTcp.Server
{
    internal partial class NetServerMain : NetServerInterface
    {
        ...
        public NetServerMain()
        {
            ...
            int nMaxPlayerCount = Config.MaxPlayerCount;
            mFakeSocketPool = new FakeSocketPool(this, 0, nMaxPlayerCount);
            mAcceptSocketDic = new Dictionary<string, FakeSocket>(nMaxPlayerCount);

            mClientPeerPool = new ClientPeerPool(this, 0, nMaxPlayerCount);
