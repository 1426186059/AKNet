...
namespace KNet.BoringSSL
{
    ...
    internal static unsafe partial class BoringSSLFunc
    {
        ...
        public static IntPtr SSL_CTX_new()
        {
            try
            {
                return BoringSSLNativeFunc.KNet_SSL_CTX_new();
            }
        ...
        {
            BoringSSLNativeFunc.KNet_SSL_CTX_free(x);
        }
        ...
        public static int SSL_provide_quic_data(IntPtr ssl, ssl_encryption_level_t level, ReadOnlySpan<byte> data)
        {
            fixed (byte* p = data)
            {
                return BoringSSLNativeFunc.KNet_SSL_provide_quic_data(ssl, level, p, data.Length);
            }
        }

        public static int SSL_CTX_set_min_proto_version(IntPtr ctx, UInt16 version)
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_set_min_proto_version(ctx, version);
        }

        public static int SSL_CTX_set_max_proto_version(IntPtr ctx, UInt16 version)
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_set_max_proto_version(ctx, version);
        }
        ...
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_set_ciphersuites(ctx, str);
        }

        public static int SSL_CTX_set_default_verify_paths(IntPtr ctx)
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_set_default_verify_paths(ctx);
        }
        ...
        public static int SSL_CTX_set_quic_method(IntPtr ctx, SSL_QUIC_METHOD meths)
        {
            ...
            return BoringSSLNativeFunc.KNet_SSL_CTX_set_quic_method(ctx, ptr);
        }
        ...
        public static int SSL_set_app_data<T>(IntPtr ssl, T AppData) where T : class
        {
            ...
            return BoringSSLNativeFunc.KNet_SSL_set_app_data(ssl, (void*)GCHandle.ToIntPtr(hObject));
        }

        //��ͨ�������� SSL/TLS �����а�һЩ��������Ϣ�������û��Ự������״̬���û����ݽṹ�ȡ�
        public static T SSL_get_app_data<T>(IntPtr ssl)
        {
            IntPtr data = BoringSSLNativeFunc.KNet_SSL_get_app_data(ssl);
        ...
        {
            return BoringSSLNativeFunc.KNet_SSL_CIPHER_get_id(cipher);
        }

        public static IntPtr SSL_get_current_cipher(IntPtr ssl)
        {
            return BoringSSLNativeFunc.KNet_SSL_get_current_cipher(ssl);
        }

        public static long SSL_CTX_set_session_cache_mode(IntPtr ctx, long m)
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_set_session_cache_mode(ctx, m);
        }

        public static void SSL_CTX_sess_set_new_cb(IntPtr ctx, func_new_session_cb new_session_cb)
        {
            BoringSSLNativeFunc.KNet_SSL_CTX_sess_set_new_cb(ctx, Marshal.GetFunctionPointerForDelegate(new_session_cb));
        }

        public static IntPtr BIO_new()
        {
            return BoringSSLNativeFunc.KNet_BIO_new();
        }

        public static int BIO_free(IntPtr bio)
        {
            return BoringSSLNativeFunc.KNet_BIO_free(bio);
        }

        public static long BIO_get_mem_data(IntPtr bio, out Span<byte> Data)
        {
            IntPtr DataPtr = IntPtr.Zero;
            long nLength = BoringSSLNativeFunc.KNet_BIO_get_mem_data(bio, out DataPtr);
        ...
        public static IntPtr BIO_new_mem_buf(Span<byte> buf)
        {
            fixed (byte* p = buf)
            {
                return BoringSSLNativeFunc.KNet_BIO_new_mem_buf(p, buf.Length);
            }
        }

        public static IntPtr SSL_new(IntPtr ctx)
        {
            return BoringSSLNativeFunc.KNet_SSL_new(ctx);
        }

        public static int PEM_write_bio_SSL_SESSION(IntPtr bio, IntPtr x)
        {
            return BoringSSLNativeFunc.KNet_PEM_write_bio_SSL_SESSION(bio, x);
        }

        public static IntPtr PEM_read_bio_SSL_SESSION(IntPtr bio, out IntPtr session, IntPtr cb, IntPtr u)
        {
            return BoringSSLNativeFunc.KNet_PEM_read_bio_SSL_SESSION(bio, out session, cb, u);
        }

        public static int SSL_set_session(IntPtr ssl, IntPtr session)
        {
            return BoringSSLNativeFunc.KNet_SSL_set_session(ssl, session);
        }

        public static void SSL_SESSION_free(IntPtr session)
        {
            BoringSSLNativeFunc.KNet_SSL_SESSION_free(session);
        }

        public static void SSL_set_quic_use_legacy_codepoint(IntPtr ssl, bool use_legacy)
        {
            BoringSSLNativeFunc.KNet_SSL_set_quic_use_legacy_codepoint(ssl, use_legacy ? 1 : 0);
        }
        ...
        public static int SSL_set_quic_transport_params(IntPtr ssl, ReadOnlySpan<byte> paramsBuffer)
        {
            ...
            {
                return BoringSSLNativeFunc.KNet_SSL_set_quic_transport_params(ssl, p, paramsBuffer.Length);
            }
        }

        public static void SSL_set_accept_state(IntPtr ssl)
        {
            BoringSSLNativeFunc.KNet_SSL_set_accept_state(ssl);
        }

        public static void SSL_set_connect_state(IntPtr ssl)
        {
            BoringSSLNativeFunc.KNet_SSL_set_connect_state(ssl);
        }

        public static long SSL_set_tlsext_host_name(IntPtr ssl, string url)
        {
            return BoringSSLNativeFunc.KNet_SSL_set_tlsext_host_name(ssl, url);
        }
        ...
        public static int SSL_set_alpn_protos(IntPtr ssl, ReadOnlySpan<byte> protos)
        {
            fixed (byte* p = protos)
            {
                return BoringSSLNativeFunc.KNet_SSL_set_alpn_protos(ssl, p, protos.Length);
            }
        }

        public static void SSL_set_quic_early_data_enabled(IntPtr ssl, bool enabled)
        {
            BoringSSLNativeFunc.KNet_SSL_set_quic_early_data_enabled(ssl, enabled ? 1 : 0);
        }
        ...
        public static void SSL_get_peer_quic_transport_params(IntPtr ssl, out Span<byte> paramsBuffer)
        {
            ...
            int nLength = 0;
            BoringSSLNativeFunc.KNet_SSL_get_peer_quic_transport_params(ssl, out paramsBufferPtr, out nLength);
        ...
        public static int SSL_SESSION_set1_ticket_appdata(IntPtr session, ReadOnlySpan<byte> data)
        {
            fixed (byte* p = data)
            {
                return BoringSSLNativeFunc.KNet_SSL_SESSION_set1_ticket_appdata(session, p, data.Length);
            }
        }

        public static int SSL_process_quic_post_handshake(IntPtr ssl)
        {
            return BoringSSLNativeFunc.KNet_SSL_process_quic_post_handshake(ssl);
        }

        public static int SSL_new_session_ticket(IntPtr ssl)
        {
            return BoringSSLNativeFunc.KNet_SSL_new_session_ticket(ssl);
        }

        public static int SSL_do_handshake(IntPtr ssl)
        {
            return BoringSSLNativeFunc.KNet_SSL_do_handshake(ssl);
        }

        public static int SSL_session_reused(IntPtr ssl)
        {
            return BoringSSLNativeFunc.KNet_SSL_session_reused(ssl);
        }

        public static int SSL_get_early_data_status(IntPtr ssl)
        {
            return BoringSSLNativeFunc.KNet_SSL_get_early_data_status(ssl);
        }
        ...
        public static void SSL_get0_alpn_selected(IntPtr ssl, out Span<byte> data)
        {
            byte* paramsBufferPtr = null;
            int nLength = 0;
            BoringSSLNativeFunc.KNet_SSL_get0_alpn_selected(ssl, out paramsBufferPtr, out nLength);
            data = new Span<byte>(paramsBufferPtr, nLength);
        }

        public static int SSL_get_error(IntPtr ssl, int ret_code)
        {
            return BoringSSLNativeFunc.KNet_SSL_get_error(ssl, ret_code);
        }

        public static IntPtr SSL_get_session(IntPtr ssl)
        {
            return BoringSSLNativeFunc.KNet_SSL_get_session(ssl);
        }
        ...
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_set_max_early_data(ctx, max_early_data);
        }
        ...
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_set_session_ticket_cb(ctx, gen_cb, dec_cb, null);
        }

        public static int SSL_CTX_set_num_tickets(IntPtr ctx, int num_tickets)
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_set_num_tickets(ctx, num_tickets);
        }

        public static void SSL_CTX_set_default_passwd_cb_userdata(IntPtr ctx, object u)
        {
            IntPtr uPtr = IntPtr.Zero;
            BoringSSLNativeFunc.KNet_SSL_CTX_set_default_passwd_cb_userdata(ctx, uPtr);
        }

        public static int SSL_CTX_use_PrivateKey_file(IntPtr ctx, string file, int type)
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_use_PrivateKey_file(ctx, file, type);
        }

        public static int SSL_CTX_use_certificate_chain_file(IntPtr ctx, string file)
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_use_certificate_chain_file(ctx, file);
        }

        public static int SSL_CTX_use_PrivateKey(IntPtr ctx, IntPtr pkey)
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_use_PrivateKey(ctx, pkey);
        }

        public static int SSL_CTX_use_certificate(IntPtr ctx, IntPtr x)
        {
            return BoringSSLNativeFunc.KNet_SSL_CTX_use_certificate(ctx, x);
        }

        //�������õ���һ�� �ڴ� BIO��BIO_TYPE_MEM�� ��ȡ����ʱ����û�и������ݿɶ�������£����ﵽ EOF�������ص�Ĭ��ֵ��
        public static long BIO_set_mem_eof_return(IntPtr bp, long larg)
        {
            return BoringSSLNativeFunc.KNet_BIO_set_mem_eof_return(bp, larg);
        }
        ...
        public static int BIO_write(IntPtr b, Span<byte> data)
        {
            fixed (byte* ptr = data)
            {
                return BoringSSLNativeFunc.KNet_BIO_write(b, ptr, data.Length);
            }
        }
        ...
        public static int SSL_SESSION_get0_ticket_appdata(IntPtr ss, out ReadOnlySpan<byte> data)
        {
            byte* dataPtr = null;
            int nLength = 0;
            int rt = BoringSSLNativeFunc.KNet_SSL_SESSION_get0_ticket_appdata(ss, out dataPtr, out nLength);
        ...
        public static int SSL_client_hello_get0_ext(IntPtr ss, uint type, out ReadOnlySpan<byte> data)
        {
            byte* dataPtr = null;
            int nLength = 0;
            int rt = BoringSSLNativeFunc.KNet_SSL_client_hello_get0_ext(ss, type, out dataPtr, out nLength);
            data = new ReadOnlySpan<byte>(dataPtr, nLength);
            return rt;
        }
        ...
        {
            return BoringSSLNativeFunc.KNet_X509_STORE_CTX_get0_cert(ctx);
        }

        public static IntPtr X509_STORE_CTX_get_ex_data(IntPtr ctx)
        {
            return BoringSSLNativeFunc.KNet_X509_STORE_CTX_get_ex_data(ctx);
        }
        
        public static int X509_verify_cert(IntPtr ctx)
        {
            return BoringSSLNativeFunc.KNet_X509_verify_cert(ctx);
        }

        public static void X509_STORE_CTX_set_error(IntPtr ctx, int s)
        {
             BoringSSLNativeFunc.KNet_X509_STORE_CTX_set_error(ctx, s);
        }

        public static int X509_STORE_CTX_get_error(IntPtr ctx)
        {
            return BoringSSLNativeFunc.KNet_X509_STORE_CTX_get_error(ctx);
        }

        public static void OPENSSL_free(IntPtr ptr)
        {
            BoringSSLNativeFunc.KNet_OPENSSL_free(ptr);
        }
        ...
        {
            byte* dataPtr = null;
            int nLength = BoringSSLNativeFunc.KNet_i2d_X509(x, out dataPtr);
            outBuf = new ReadOnlySpan<byte>(dataPtr, nLength);
        }
        public static void i2d_PKCS7(IntPtr x, out ReadOnlySpan<byte> outBuf)
        {
            byte* dataPtr = null;
            int nLength = BoringSSLNativeFunc.KNet_i2d_PKCS7(x, out dataPtr);
            outBuf = new ReadOnlySpan<byte>(dataPtr, nLength);
        }

        public static IntPtr X509_STORE_CTX_get0_chain(IntPtr ctx)
        {
            return BoringSSLNativeFunc.KNet_X509_STORE_CTX_get0_chain(ctx);
        }

        public static int sk_X509_num(IntPtr ctx)
        {
            return BoringSSLNativeFunc.KNet_sk_X509_num(ctx);
        }

        public static IntPtr PKCS7_new()
        {
            return BoringSSLNativeFunc.KNet_PKCS7_new();
        }

        public static void PKCS7_free(IntPtr a)
        {
            BoringSSLNativeFunc.KNet_PKCS7_free(a);
        }

        public static int PKCS7_set_type(IntPtr p7, int type)
        {
            return BoringSSLNativeFunc.KNet_PKCS7_set_type(p7, type);
        }

        public static int PKCS7_content_new(IntPtr p7, int nid)
        {
            return BoringSSLNativeFunc.KNet_PKCS7_content_new(p7, nid);
        }

        public static int PKCS7_add_certificate(IntPtr p7, IntPtr x)
        {
            return BoringSSLNativeFunc.KNet_PKCS7_add_certificate(p7, x);
        }

        public static IntPtr sk_X509_value(IntPtr sk, int idx)
        {
            return BoringSSLNativeFunc.KNet_sk_X509_value(sk, idx);
        }
