...
namespace KNet.Common
{
    ...
    */
    ...
    {
        private static string storeName = "knet_quic_test_cert";
        private const string pem_fileName = "knet_quic_test_cert.pem";
        private const string pfx_fileName = "knet_quic_test_cert.pfx";
        private const string cert_fileName = "knet_quic_test_cert.cert";
