...
namespace KNet.Common.Channel
{
    internal class KNetChannel<T>
    {
        ...
        internal KNetChannel(bool runContinuationsAsynchronously)
        {
        ...
        {
            internal readonly KNetChannel<T> _parent;
            private readonly AsyncOperation<T> _readerSingleton;
            private readonly AsyncOperation<bool> _waiterSingleton;

            internal UnboundedChannelReader(KNetChannel<T> parent)
            {
                _parent = parent;
            ...
            private static void CompleteIfDone(KNetChannel<T> parent)
            {
        ...
        {
            internal readonly KNetChannel<T> _parent;
            internal UnboundedChannelWriter(KNetChannel<T> parent) => _parent = parent;
