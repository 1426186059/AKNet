...
{
    public class NetClientMainBase : ClientPeerBase, NetClientInterface
    {
        ...
        public void SendNetData(NetPackage mNetPackage) { mInterface.SendNetData(mNetPackage); }
        public void SendNetData(byte[] data) { mInterface.SendNetData(0, data); }
        public void SendNetData(ReadOnlySpan<byte> data) { mInterface.SendNetData(0, data); }
